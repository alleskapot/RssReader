...
public class RssFeedModel implements Parcelable {
    ...
    private ArrayList<RssItemModel> rssItems;

    public RssFeedModel() {
        rssItems = new ArrayList<RssItemModel>();
    }

    public RssFeedModel(Parcel source) {
    ...
    public static final Creator<RssFeedModel> CREATOR = new Creator<RssFeedModel>() {
        public RssFeedModel createFromParcel(Parcel data) {
            return new RssFeedModel(data);
        }
    ...
    void addRssItem(RssItemModel rssItem) {
    ...
    public ArrayList<RssItemModel> getRssItems() {
        return rssItems;
    }

    public void setRssItems(ArrayList<RssItemModel> rssItems) {
