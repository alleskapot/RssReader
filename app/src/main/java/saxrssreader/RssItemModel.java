...
public class RssItemModel implements Comparable<RssItemModel>, Parcelable {
    ...
    public RssItemModel(Parcel source) {
    ...
    public static final Creator<RssItemModel> CREATOR = new Creator<RssItemModel>() {
        public RssItemModel createFromParcel(Parcel data) {
            return new RssItemModel(data);
        }
    ...
    public RssFeedModel getFeed() {
        return feed;
    }

    public void setFeed(RssFeedModel feed) {
        this.feed = feed;
    }
    ...
    @Override
    public int compareTo(RssItemModel another) {
